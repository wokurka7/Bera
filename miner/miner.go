...
type BlockChain interface {
	...
	GetOverridenState() (state.StateDBI, error)
}
...
// Etherbase returns the current etherbase address used by the miner for mining.
func (miner *Miner) Etherbase() common.Address {
	return miner.worker.etherbase()
}

// SetEtherbase sets the etherbase address used by the miner for mining.
