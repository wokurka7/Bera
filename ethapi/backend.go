...
type Backend interface {
	...
	GetBlockContext(context.Context, *types.Header) *vm.BlockContext
	...
	GetEVM(ctx context.Context, msg *core.Message, state state.StateDBI, header *types.Header, vmConfig *vm.Config, blockCtx *vm.BlockContext) *vm.EVM
